  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="mb-6 flex flex-col sm:flex-row gap-4 items-center justify-between bg-gray-100 p-4 rounded-lg">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-16 mx-8">
          ...
          {paginatedArticles.map((article) => (
            <div
              ...
              className={`p-4 rounded-lg shadow-md transition-transform duration-200 hover:shadow-xl hover:-translate-y-1 flex flex-col cursor-pointer relative ${getThemeClasses(
                theme,
                "preview"
              )}`}
            >
