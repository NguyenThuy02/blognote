...
<div className="mb-21">
          ...
          <div
            ref={sidebarRef}
            className={`lg:w-1/4 lg:min-w-[300px] lg:max-w-[450px] fixed lg:static top-[115px] right-0 h-[70%] bg-blue-100 mt-3 mr-3 border-gray-200 p-4 shadow-md transition-all duration-300 flex-shrink-0 overflow-y-auto lg:overflow-y-visible rounded-lg ${
