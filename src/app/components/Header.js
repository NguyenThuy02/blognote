      ...
      <nav className="flex space-x-6">
        ...
        <div className="relative group">
          ...
          <div className="absolute left-0 mt-2 w-56 bg-white shadow-md rounded-lg py-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
            <Link
              href="/reminders"
              className="block px-4 py-2 text-black hover:bg-gradient-to-r hover:from-blue-500 hover:to-purple-500 hover:bg-clip-text hover:text-transparent transition-all"
            >
              Danh sách nhắc nhở
            </Link>
            <Link
